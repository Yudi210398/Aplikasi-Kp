...
routerCustomer.post("/ukuranCelana", controller.postUkuranCelana);
routerCustomer.post("/ukuranJas", controller.postUkuranjas);
...
routerCustomer.post("/cari-data", controller.postCariData);
